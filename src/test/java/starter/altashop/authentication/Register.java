...
public class Register {
    ...
    @Step("I submit a POST request to {string} with fullname Firstname Lastname, email sela123@gmail.com and password sela123")
    public void POSTRequestToWithFullnameEmailAndPassword(){
        String alphabet = "abcdef";
        String s = RandomStringUtils.random(8, alphabet);
        JSONObject requestBody = new JSONObject();
        requestBody.put("fullname", "sela putri");
        requestBody.put("email",s + "@gmail.com");
        requestBody.put("password", "sela123");
